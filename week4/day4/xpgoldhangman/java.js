...
while (player1Word.length < 8){
    player1Word = prompt("choose a word of 8 letter or more: ");
}

var WordinAsterisc = "*".repeat(player1Word.length);
...
var wordToBeReplacing = WordinAsterisc.slice(); //create a copy of the astherisc word
var player2Guess = "";
console.log(wordToBeReplacing);
...
if(wordToBeReplacing != player1Word) {
    console.log(wordToBeReplacing);
    var player2Guess = prompt("guess a letter: ");
    
    while (player1Word.includes(player2Guess)) {
        
        var position_of_the_letter = player1Word.indexOf(player2Guess);
        var wordToBeReplacing = wordToBeReplacing.substring(0, position_of_the_letter) 
        + player2Guess + wordToBeReplacing.substring(position_of_the_letter-1, player1Word.length);
        var player1Word = player1Word.substring(0, position_of_the_letter) + "*"
        + player1Word.substring(position_of_the_letter + 1, player1Word.length);
        console.log(position_of_the_letter);
        console.log(wordToBeReplacing);
