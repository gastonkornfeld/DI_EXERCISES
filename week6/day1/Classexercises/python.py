...
"""
The purpouse of this excersice is to work with variables and for loop in python.
This exercises are part of the developers insitute fullstack developer course.
